<?php
require_once SPAPP_PATH."Core/Library/Vendor/Wxpay/WxPay.Exception.php";
require_once SPAPP_PATH."Core/Library/Vendor/Wxpay/WxPay.Config.php";
require_once SPAPP_PATH."Core/Library/Vendor/Wxpay/WxPay.Data.php";
/**
 * 
